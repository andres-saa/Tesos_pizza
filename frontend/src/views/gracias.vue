    ...
    <div class="shadow-3 p-4" style="border-radius: 0.5rem; max-width: 500px;">
      ...
      <div id="factura" style="width: 100%;text-transform: uppercase;">
        ...
        <div class="" style="width: auto; color: black;">
          ...
          <div class=""
            style="font-weight: bold;color:white;margin: 0;justify-content: space-between; background-color: black;align-items: center;display: grid; grid-template-columns: auto auto; ">
          ...
          <div v-for="product in store.cart.products">
            ...
            <div style="display: grid; grid-template-columns: auto auto;">
              ...
              <p class="p-0 m-0" style="margin: 0;padding: 0;">
                {{ product.quantity }}
                {{ product.product.product_name }}
              </p>

              <div>
                <p style="text-align: end;color: black;padding: 0;margin: 0;">
            ...
            <div
              ...
              <div style="display: flex; gap: 0.2rem; align-items: end; flex-direction: column;">
                <Tag v-for="(flavor, index) in product.flavors" :key="index" style="padding: 0;">
                  ...
                  {{ flavor.name }}
                  {{ flavor.price > 0 ? formatoPesosColombianos(product.flavors.length > 1 ? flavor.price / 2 :
                    flavor.price) : '' }}
                </Tag>
              </div>
          ...
          <!-- 
          <div v-for="(items, grupo) in {
            ADICIONES: store.cart.additions.filter(a => a.group == 'ADICIONES'),
            SALSAS: store.cart.additions.filter(a => a.group == 'SALSAS'),
            CAMBIOS: store.cart.additions.filter(a => a.group == 'CAMBIOS')
          } " :key="grupo" style="position: relative; margin-top: 0.5rem;">
          ...
          <div class="" style="display: grid ;color: ;margin-top: 0.5rem; grid-template-columns: auto auto">
            ...
            <div class="">
              <p style="text-align: end;font-weight: bold; color: black;margin: 0;">
            ...
            <div class="">
              ...
              <p style="text-align: end;font-weight: bold;color: black;margin: 0;"> <b>
            ...
            <div class="">
              ...
              <p style="text-align: end;color: black;font-weight: bold;"><b>{{
                formatoPesosColombianos(site.location?.neigborhood?.delivery_price + store.cart.total_cost)
                  }}</b></p>
