...
<template>
    ...
    <div class="layout-topbar shadow-2 lg:pl-8 lg:pr-8 md:pr-8 " style=" background-color: #cd1f30; ">
        ...
        <button class="p-link boton-menu layout-topbar-logo"
            ...
            <i sty :class="PrimeIcons.MAP_MARKER" style="font-size: 100%; color: #fff"> </i>
        ...
        <button v-if="33 == 54" style="border: none" class="p-link layout-menu-button layout-topbar-button"
            @click="onMenuToggle()">
        ...
        <div v-else class="" style="left: 0; position: ; display: flex;gap: 1rem; width: 100%;justify-content: center;"> 
            ...
            <div v-for=" menu in menus" class="p-0 " style="width: max-content;">
                ...
                <RouterLink cla :to="menu.to" class="link-menu " style="text-decoration: none;color: black;">
                    ...
                    <Button :label=" menu.name " text class="col-12 text-md text-center p-1 p-" :class="ruta.fullPath == menu.to ? 'selected' : 'menu'"
                        style="font-weight: ;background-color: rgb(255, 255, 255);color: white;background-color: transparent;text-transform: uppercase; " ></Button>
